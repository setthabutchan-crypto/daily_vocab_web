    ...
    const handleSubmitSentence = () => {
        if (currentWord) {
            ...
            history.push({
                ...
                sentence: sentence,
                score: newScore,
                difficulty: currentWord.definifion_level,
        ...
        <div className="container mx-auto p-4 max-w-3xl">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl mb-6 border border-gray-100 transform hover:scale-105 transition-transform duration-300 ease-in-out">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                    ...
                    <span className={`px-4 py-1 rounded-full text-sm font-semibold ${getDifficultyColor(currentWord.definifion_level)} shadow-md`}>
                        {currentWord.definifion_level}
                    </span>
                </div>
                <p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed">{currentWord.definifion_level}</p>
